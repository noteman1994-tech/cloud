...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	...
	return &PublicSettings{
		...
		SiteName:                         normalizeBrandName(s.getStringOrDefault(settings, SettingKeySiteName, defaultBrandName)),
		SiteLogo:                         settings[SettingKeySiteLogo],
		SiteSubtitle:                     normalizeBrandSubtitle(s.getStringOrDefault(settings, SettingKeySiteSubtitle, defaultBrandSubtitle)),
		APIBaseURL:                       settings[SettingKeyAPIBaseURL],
		ContactInfo:                      settings[SettingKeyContactInfo],
		DocURL:                           normalizeBrandDocURL(s.getStringOrDefault(settings, SettingKeyDocURL, defaultBrandDocURL)),
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeySiteName:                                 defaultBrandName,
		SettingKeySiteLogo:                                 "",
		SettingKeyDocURL:                                   defaultBrandDocURL,
